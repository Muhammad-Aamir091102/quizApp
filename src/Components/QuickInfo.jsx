...
const QuickInfo = () => {
    return (
        <>
            <WhoUsesTitle>Who uses <b>QUIZIFY</b></WhoUsesTitle>
            <Container>
                <Section>
                ...
                <Section>
                    ...
                    <Info>
                        ...
                        <Description>Quickly create online tests for your students. And you can publish your test for free. The auto-grading function will save you time.</Description>
                    </Info>
                </Section>
                <Section>
